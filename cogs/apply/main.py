...
from nextcord import Interaction, SlashOption, SelectOption, TextInputStyle, Embed, Color, slash_command, ui
...
class Apply(commands.Cog):
    ...
    async def apply(self, interaction: Interaction, type: str = SlashOption(
		    name="type",
        ...
        if type == "Minecraft":
            ...
            serversubtype_select_options = [
                ...
                SelectOption(label="Forge", description="Forge is a popular mod loader for Minecraft that allows users to add mods."),
                SelectOption(label="Fabric", description="Fabric is primarily designed for running modded clients but also servers."),
                SelectOption(label="Vanilla", description="Plain vanilla server software, if you're nostalgic."),
